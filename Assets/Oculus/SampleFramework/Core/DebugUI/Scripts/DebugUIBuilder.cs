...
public class DebugUIBuilder : MonoBehaviour
{
  ...
  public RectTransform AddButton(string label, OnClick handler = null, int buttonIndex = -1, int targetCanvas = 0, bool highResolutionText = false)
  {
    ...
    if(handler != null)
      ...
      if(highResolutionText){
        ...
        ((TMP_Text)(buttonRT.GetComponentsInChildren(typeof(TMP_Text), true)[0])).text = label;
      }
  ...
  public RectTransform AddLabel(string label, int targetCanvas = 0)
  {
    ...
    rt.GetComponent<TMP_Text>().text = label;
  ...
  public RectTransform AddToggle(string label, OnToggleValueChange onValueChanged, int targetCanvas = 0)
  {
    ...
    AddRect(rt, targetCanvas);
    TMP_Text buttonText = rt.GetComponentInChildren<TMP_Text>();
